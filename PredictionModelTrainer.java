...
public class PredictionModelTrainer {
    ...
    /*
     * loadDataset() - this function loads the data from csv and removes all dupliactes values from it
     * @param spark
     * @param csvFile
    ...
    /*
     * transformDataset() this funcation will transforms the cleaned dataset into Vector
    ...
    public Dataset<Row> transformDataset(Dataset<Row> cleanedDataSet){
         ...
         */
        Dataset<Row> transformedDataSet = vectorAssembler.transform(cleanDataSet).select("features", "quality").cache();
    ...
    public static void main(String[] args) {
         ...
         */
        if (args.length < 3) {
            System.err.println("This ML training model requires three arguments: training set, validation set, prediction modal path");
            System.exit(1);
        }
        ...
        /*
         * Configure an ML pipeline, which consist a stage for the training model
         */
        ...
        /*
         * Loads and transforms validation data set
         */
